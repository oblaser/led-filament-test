...
void bounce()
{
    ...
    if (tmr_led == 0)
    {
        ...
        if (state == 0) BCMLED_setRGBW(value, 0, 0, 0);
        else if (state == 1) BCMLED_setRGBW(0, value, 0, 0);
        else if (state == 2) BCMLED_setRGBW(0, 0, value, 0);
        else if (state == 3) BCMLED_setRGBW(0, 0, 0, value);
        else if (state == 4) BCMLED_setRGBW(value, value, 0, 0);
        else if (state == 5) BCMLED_setRGBW(0, value, value, 0);
        else if (state == 6) BCMLED_setRGBW(value, 0, value, 0);
    }
}
