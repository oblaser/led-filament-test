...
/* Private defines -----------------------------------------------------------*/
#define GPIO_PWM_1_Pin GPIO_PIN_6
#define GPIO_PWM_1_GPIO_Port GPIOA
#define GPIO_PWM_2_Pin GPIO_PIN_7
#define GPIO_PWM_2_GPIO_Port GPIOA
#define GPIO_PWM_3_Pin GPIO_PIN_0
#define GPIO_PWM_3_GPIO_Port GPIOB
#define GPIO_PWM_4_Pin GPIO_PIN_1
